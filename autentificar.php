...
if( ($_POST['email'] == ' ') or ($_POST['contrasena'] == ' ') )//comprobamos que las variables enviadas por el form de login.php tienen contenido
{
...
$usuario=mysql_query("SELECT * FROM admins WHERE email='$_POST[email]' and password='$pass'");
