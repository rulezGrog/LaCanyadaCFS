									...
									<div class='row form-group paneledit in' id='editpanel1-$id'>
										<form accept-charset='utf-8' role='form' action='editplayer.php?id=$id&op=edit1' method='POST'>
											...
											<div class='form-group col-sm-7'>
												...
												<input type='text' class='form-control' id='apellidostut' name='apellidostut' placeholder='Introduzca los apellidos' value='"; echo str_replace('%ufffd', "_",$apellidostut); echo"'>
											</div>
											<div class='form-group col-sm-5'>
